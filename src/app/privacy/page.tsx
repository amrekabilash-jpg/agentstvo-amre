...
export const metadata: Metadata = {
  ...
  description: "Политика конфиденциальности цифрового агентства Агентсво. Обработка персональных данных.",
        ...
        <div className="container-atlantis max-w-3xl">
          ...
          <div className="space-y-8 text-body leading-relaxed">
            <section>
              ...
              <p>Настоящая Политика конфиденциальности определяет порядок обработки и защиты персональных данных пользователей сайта agentsvo.com (далее — «Сайт»), принадлежащего ТОО «Агентсво» (далее — «Компания»).</p>
            </section>
