...
export const metadata: Metadata = {
  ...
  description:
    "Реальные кейсы digital-агентства Агентсво. SEO-продвижение, креативные проекты и AI-автоматизация для бизнеса в Казахстане. Rentai, Baurzan & CO, Asil Partners, Renkie.ai.",
  keywords: [
  ...
  openGraph: {
    title: "Кейсы и портфолио | Агентсво",
